...
export const ProposalApi = {
    ...
    updateProposal: (id: string, data: UpdateProposalDto) => api.put(API_ENDPOINTS.proposals.updateProposal.replace(':id', id), data),
    acceptProposal: (id: string) => api.post(API_ENDPOINTS.proposals.acceptProposal.replace(':id', id)),
    rejectProposal: (id: string) => api.post(API_ENDPOINTS.proposals.rejectProposal.replace(':id', id)),
    withdrawProposal: (id: string) => api.post(API_ENDPOINTS.proposals.withdawProposal.replace(':id', id)),
