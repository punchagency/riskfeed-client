...
import { useGetProjectDisputes, useRespondToDispute } from '@/hooks/use-disputes'
import type { IDispute } from '@/interfaces/disputes/dispute.interface'
import { cn } from '@/lib/utils'
import { DisputeCard } from '@/pages/user/escrow-payment/components/dispute-card'
import { DisputePageLoading } from '@/pages/user/escrow-payment/components/dispute-loading'
import { DisputeEmpty } from '@/pages/user/escrow-payment/components/dispute-empty'
