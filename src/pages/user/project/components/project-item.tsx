        ...
        >
            <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                    <h3 className="text-xl text-secondary-foreground font-semibold mb-1 group-hover:text-primary transition-colors">
                        {project.title}
                    </h3>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-secondary-foreground font-medium">{formatBudget(project.minBudget, project.maxBudget)}</p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-secondary-foreground font-medium">{formatTimeline()}</p>
                    </div>
                </div>
            </div>
        </div>
